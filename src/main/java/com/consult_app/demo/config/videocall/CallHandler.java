...
import com.consult_app.demo.config.session.UserSession;
...
public class CallHandler extends TextWebSocketHandler {
    ...
    public void stop(WebSocketSession session) throws IOException {
        ...
        if (pipelines.containsKey(sessionId)) {
            ...
            if (stopperUser != null) {
                UserSession stoppedUser = (stopperUser.getCallingFrom() != null) ? registry.getByName(stopperUser
                        .getCallingFrom())
                        : stopperUser.getCallingTo() != null ? registry
